...
mongoose
  .connect(
    "mongodb+srv://kaveem:ByQkVHrIM7T8maAO@cluster0.4vx5wrd.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0"
  )
  .then(() => {
...
app.post("/post", uploadMiddleware.single("file"), async (req, res) => {
  ...
  jwt.verify(token, secret, {}, async (err, info) => {
    if (err) console.log("error in JWT Token", err);
...
/** Get Posts */
app.get(`${process.env.URL}/post`, async (req, res) => {
